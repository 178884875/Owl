        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentType = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: false),
                    Size = table.Column<int>(type: "INT", nullable: false),
                    ProviderId = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TIMESTAMP", nullable: false),
                    CreatedBy = table.Column<string>(type: "NVARCHAR2(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "BIGINT", nullable: false)
                        .Annotation("Dm:Identity", "1, 1"),
                    Provider = table.Column<string>(type: "NVARCHAR2(450)", nullable: false),
                    Endpoint = table.Column<string>(type: "NVARCHAR2(32767)", nullable: false),
                    ModelIds = table.Column<string>(type: "NVARCHAR2(32767)", nullable: false),
                    ...
                    Keys = table.Column<string>(type: "NVARCHAR2(32767)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TIMESTAMP", nullable: false),
                    CreatedBy = table.Column<string>(type: "NVARCHAR2(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "NVARCHAR2(450)", nullable: false),
                    Provider = table.Column<string>(type: "NVARCHAR2(450)", nullable: false),
                    ModelId = table.Column<string>(type: "NVARCHAR2(32767)", nullable: false),
                    DisplayName = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: false),
                    ...
                    Pricing = table.Column<string>(type: "NVARCHAR2(32767)", nullable: false),
                    ReleasedAt = table.Column<string>(type: "NVARCHAR2(32767)", nullable: true),
                    Abilities = table.Column<string>(type: "NVARCHAR2(32767)", nullable: false),
                    Resolutions = table.Column<string>(type: "NVARCHAR2(32767)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderUserId = table.Column<string>(type: "NVARCHAR2(450)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TIMESTAMP", nullable: false),
                    CreatedBy = table.Column<string>(type: "NVARCHAR2(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayName = table.Column<string>(type: "NVARCHAR2(32767)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileId = table.Column<string>(type: "NVARCHAR2(450)", nullable: false),
                    FileName = table.Column<string>(type: "NVARCHAR2(32767)", nullable: false),
                    FileSize = table.Column<long>(type: "BIGINT", nullable: false),
                    FileUrl = table.Column<string>(type: "NVARCHAR2(32767)", nullable: false),
                    FileStorageId = table.Column<string>(type: "NVARCHAR2(450)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TIMESTAMP", nullable: false),
                    CreatedBy = table.Column<string>(type: "NVARCHAR2(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "BIGINT", nullable: false)
                        .Annotation("Dm:Identity", "1, 1"),
                    MessageId = table.Column<long>(type: "BIGINT", nullable: false),
                    ReasoningUpdate = table.Column<string>(type: "NVARCHAR2(32767)", nullable: true),
                    Text = table.Column<string>(type: "NVARCHAR2(32767)", nullable: false),
                    SearchResults = table.Column<string>(type: "NVARCHAR2(32767)", nullable: false),
                    ExtraData = table.Column<string>(type: "NVARCHAR2(32767)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TIMESTAMP", nullable: false),
                    CreatedBy = table.Column<string>(type: "NVARCHAR2(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpireTime = table.Column<DateTime>(type: "TIMESTAMP", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionGroupId = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TIMESTAMP", nullable: false),
                    CreatedBy = table.Column<string>(type: "NVARCHAR2(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
